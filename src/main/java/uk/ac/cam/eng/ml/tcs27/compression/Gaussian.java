...
/* $Id: Gaussian.java,v 1.14 2015/08/11 11:28:16 chris Exp $ */
...
public class Gaussian extends SimpleDensity<Double> {
  ...
  /** Demonstrates a Gaussian distribution by printing a histogram. */
  public static void main(String[] args) {
    Gaussian g = new Gaussian();
    Histogram gauss = Histogram.fromDoubles(g, -4.0, 4.0, 61, 100000);
    gauss.print(System.out);
