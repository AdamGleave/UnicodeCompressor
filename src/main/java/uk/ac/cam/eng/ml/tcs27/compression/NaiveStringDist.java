...
public class NaiveStringDist extends SimpleMass<String> 
  ...
  public static void main(String[] args) {
    ...
    //Distribution<Integer> ld   = new Const<Integer>(8);
    Distribution<Integer> ld   = new Binomial(9,0.9);
    Distribution<Character> cd = new UniformChar('a','z');
    int n = 30;
    NaiveStringDist nsd = new NaiveStringDist(ld,cd);
    System.err.println("Sampling "+n+" strings from "+nsd);
    for (int k=0; k < n; k++) {
      System.out.println(nsd.sample(rnd));
    }
  }
