...
public class SBST extends SimpleMass<Integer>
  ...
  public static void main(String[] args) {
    ...
    SBST toi = new SBST(-32,31);
    System.out.println(toi);
    for (int k=0; k<25; k++) {
      System.out.print(" "+toi.sample(rnd));
    }
    System.out.println();
    Histogram h = Histogram.fromIntegers(toi, -32, 32, 10000);
    // h.writeHTML(12,"ex",System.out);
    h.print(System.out);
    System.out.println(toi);
    for (int k=0; k<25; k++) {
      System.out.print(" "+toi.sample(rnd));
    ...
    System.out.println();
    SBST p1 = new SBST(0,15);
    SBST p2 = new SBST(0,15);
    double m1 = 1.0;
    double m2 = 1.0;
    m1 *= p1.mass(2); p1.learn(2);
    m1 *= p1.mass(1); p1.learn(1);
    m1 *= p1.mass(2); p1.learn(2);
    m1 *= p1.mass(8); p1.learn(8);
    m2 *= p2.mass(1); p2.learn(1);
    m2 *= p2.mass(8); p2.learn(8);
    m2 *= p2.mass(2); p2.learn(2);
    m2 *= p2.mass(2); p2.learn(2);
    System.out.println("[2123]: "+m1+"\n[1322]: "+m2);
  }
